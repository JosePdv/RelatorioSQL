...
$sql = $conn->prepare("SELECT nome as nome, protocolo as protocolo, descricaoIndeferido as motivo FROM formularios WHERE aprovado = 2 and cargo = 2 GROUP BY nome, protocolo,motivo");
...
<h5 style="text-align: center;">CARGO AGENTE DE VIGILÂNCIA EM SAÚDE </h5>
